...
public static class PlatformFactory
{
    ...
    public static ITunAdapter CreateAdapter(string name)
    {
        ...
        throw new PlatformNotSupportedException(
            "Cell2Pc supports Windows and Linux. macOS would need a utun " +
    ...
    public static IWifiJoiner CreateWifiJoiner(string ssid = "DIRECT-WD-Cell2Pc")
    {
