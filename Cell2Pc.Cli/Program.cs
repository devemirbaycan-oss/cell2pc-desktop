...
internal static class Program
{
    private static async Task<int> Main(string[] args)
    {
        ...
        catch (ArgumentException ex)
        {
            ...
            Console.Error.WriteLine("Run 'cell2pc --help' for usage.");
            return 2;
        }
        ...
        if (cmd.ShowVersion)
        {
            Console.WriteLine($"cell2pc {BuildInfo.Version} ({BuildInfo.Platform})");
            return 0;
        }
    ...
    private static int Unknown(string verb)
    {
        ...
        Console.Error.WriteLine("Run 'cell2pc --help' to see the available commands.");
        return 2;
    }
}
