...
public class CryptoTests
{
    ...
    {
        // Both sides compute SHA-256("cell2pc-v1" || token). Kotlin does it with
        ...
        var expected = SHA256.HashData(Encoding.ASCII.GetBytes("cell2pc-v1" + Token));

        // Derived indirectly: two instances agreeing proves they share a key,
        // and the vector below proves it is this one.
        Assert.Equal(
            "200e37173e12f90702ca7da6377e0e582e019ca44ed1752c20807e897d81a01a",
