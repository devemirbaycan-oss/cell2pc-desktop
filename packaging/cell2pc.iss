; Cell2Pc Windows installer (Inno Setup 6)
;
; Build with:  iscc packaging\cell2pc.iss
; Output:      packaging\output\Cell2Pc-Setup-<version>.exe
;
...
#define AppName "Cell2Pc"
#define AppVersion "1.0.0"
#define AppPublisher "Cell2Pc"
#define AppExeName "Cell2Pc-Desktop.exe"
#define CliExeName "cell2pc.exe"
...
OutputDir=output
OutputBaseFilename=Cell2Pc-Setup-{#AppVersion}
...
Name: "addtopath"; Description: "Add the cell2pc command to PATH"; GroupDescription: "Command line:"; Flags: unchecked
...
Name: "{group}\Fix my internet"; Filename: "{app}\FIX-MY-INTERNET.bat"; Comment: "Restore normal routing if Cell2Pc was interrupted"
